...
import TagAutocomplete from "./tag-autocomplete.component";
...
const PublishForm = () => {
    ...
    const publishBlog = (e) => {
        ...
        let blogObj = {
            ...
            banner, 
            des, 
            content: content.blocks ? content : { blocks: content }, 
            tags, 
            draft: false
        }

        console.log("Publishing blog with tags:", tags);
        console.log("Full blog object:", blogObj);
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <TagAutocomplete tagLimit={tagLimit} />
