...
const BlogContent = ({ block }) => {
    ...
    if (type == "code") {
        return <pre className="bg-grey p-3 rounded-md overflow-x-auto"><code dangerouslySetInnerHTML={{ __html: data.code || "" }}></code></pre>
    }

    if (type == "embed") {
        return <div className="w-full aspect-video" dangerouslySetInnerHTML={{ __html: data.embed || "" }}></div>
    }
