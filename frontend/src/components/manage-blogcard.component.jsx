...
const deleteBlog = (blog, access_token, target) => {
    ...
    .then(({ data }) => {
        ...
        setStateFunc(preVal => {
            ...
            // Tìm và xóa blog theo blog_id thay vì index
            results = results.filter(b => b.blog_id !== blog_id);
            ...
            return { ...preVal, results, totalDocs: totalDocs - 1, deletedDocCount: deletedDocCount + 1 }
        })
